...
<p>Welcome to <a href="http://eabyas.in">Eabyas</a> Blog. Please verify your email by 
<a href="{{ route('auth.verify', $token) }}"> clicking here</a>
</p> --}}
...
<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Welcome to <a href="http://eabyas.in">Eabyas</a> Blog...!</p>
...
<td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">If you’re having trouble clicking the "Activate Account" button, copy and paste the URL below
into your web browser: <a href="{{ route('auth.verify', $token) }}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{{ route('auth.verify', $token) }}</a></p>
        </td>
    </tr></table>
</td>
                                </tr>
...
<td class="content-cell" align="center" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #AEAEAE; font-size: 12px; text-align: center;">© 2017 eAbyas. All rights reserved.</p>
                </td>
            </tr></table>
</td>
</tr>
